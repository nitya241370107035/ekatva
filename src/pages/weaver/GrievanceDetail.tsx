  ...
  const handleSendReply = async (e: React.FormEvent) => {
    ...
    try {
      await addGrievanceMessage(id, {
        ...
        senderName: userProfile.displayName || 'बुनकर',
        senderRole: 'weaver',
        text: replyText.trim()
      });
      setReplyText('');
    ...
    return (
      <WeaverLayout activeTab={activeTab} setActiveTab={setActiveTab}>
        <div className="flex flex-col items-center justify-center py-24 gap-4">
          <p className="font-heading text-2xl text-loom-wood animate-pulse">शिकायत विवरण लोड हो रहा है...</p>
        </div>
      </WeaverLayout>
    );
  }
    ...
    return (
      <WeaverLayout activeTab={activeTab} setActiveTab={setActiveTab}>
        <div className="p-8 text-center vintage-card bg-loom-cream max-w-md mx-auto">
          ...
          <h2 className="font-heading text-2xl font-bold text-loom-wood">शिकायत विवरण नहीं मिला</h2>
          <Button 
  ...
  return (
    <WeaverLayout activeTab={activeTab} setActiveTab={setActiveTab}>
      ...
      <div className="mb-6">
        ...
        >
          <ArrowLeft className="w-4 h-4" /> मेरी शिकायतों पर वापस जाएं (Back to List)
        </button>
        <h1 className="font-heading text-3xl font-bold text-loom-wood">
          शिकायत एवं सहायता संवाद (My Grievance Ticket)
        </h1>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="vintage-card p-6 bg-loom-cream border-t-4 border-t-loom-wood shadow-md">
          <span className="text-xs text-loom-gold font-bold font-heading uppercase tracking-widest block mb-2">शिकायत विवरण (Grievance Summary)</span>
          ...
          <div className="mt-6 p-4 bg-amber-50/50 border border-loom-gold/20 rounded-xl text-xs text-loom-ink-light leading-relaxed font-body">
            💡 यदि सचिव साहब ने स्थिति <strong>"प्रगति पर"</strong> या <strong>"हल"</strong> में बदल दी है, तो वह आपको यहाँ चैट में विवरण के साथ दिखाई देगी।
          </div>
        </div>
        ...
        <div className="lg:col-span-2">
          <div className="vintage-card p-6 bg-loom-cream border-t-4 border-t-loom-gold shadow-md flex flex-col h-[520px]">
            <h3 className="font-heading text-lg font-bold text-loom-wood flex items-center gap-2 border-b border-loom-beige/30 pb-3 mb-4">
              ...
              सचिव साहब के साथ बातचीत सूत्र (Message Board)
            </h3>
            ...
            {grievance.status === 'resolved' ? (
              ...
              <form onSubmit={handleSendReply} className="flex gap-2 pt-2 border-t border-loom-beige/30">
                <textarea
                  placeholder="सचिव साहब को उत्तर लिखें... (Type your message...)"
                  value={replyText}
