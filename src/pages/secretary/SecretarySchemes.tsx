...
export const SecretarySchemes: React.FC = () => {
  ...
  // Certifications Toggles inside modal
  ...
  const [savingCerts, setSavingCerts] = useState<boolean>(false);
        ...
        {showCertModal && (
          <div className="fixed inset-0 z-50 overflow-y-auto bg-black/60 flex items-center justify-center p-4">
            <div className="bg-loom-cream border-2 border-loom-gold max-w-md w-full rounded-2xl shadow-2xl p-6 relative">
              ...
              <form onSubmit={handleSaveCertifications} className="space-y-4 font-body">
                <div className="space-y-3">
                  ...
                  <label className="flex items-center justify-between p-3.5 bg-white border border-loom-beige rounded-xl cursor-pointer hover:bg-loom-cream/40 transition-colors">
                    ...
                    <div className="relative inline-block w-12 h-6 select-none align-middle shrink-0">
                      ...
                      />
                      <span className="absolute cursor-pointer top-0 left-0 right-0 bottom-0 bg-loom-beige peer-checked:bg-loom-gold rounded-full transition-all duration-300 before:content-[''] before:absolute before:left-1 before:bottom-1 before:bg-white before:w-4 before:h-4 before:rounded-full before:transition-all peer-checked:before:translate-x-6" />
                    </div>
                  </label>
